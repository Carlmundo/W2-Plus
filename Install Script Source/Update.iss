#define AppName "Worms 2 Plus Update 1.5.8.x to 1.5.8.2"
...
[Files]
Source: "..\Patch\All Installs\fkUpdate.dll"; DestDir: "{app}\"; Flags: ignoreversion recursesubdirs createallsubdirs overwritereadonly;
Source: "..\Patch\All Installs\Teams\Internet.dat"; DestDir: "{app}\"; Flags: ignoreversion recursesubdirs createallsubdirs overwritereadonly;
